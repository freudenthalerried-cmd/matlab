...
const BAUSTEINE = [
  {
    ...
    mangel: 'MANGEL: Die persönliche Schutzausrüstung wird nicht verwendet. Das Tragen des Schutzhelmes ist umgehend sicherzustellen.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Verkehrswege und Arbeitsplätze sind nicht sicher begehbar. Bauschutt und Restmaterial sind umgehend von der Baustelle zu räumen.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Brust-, Mittel- und Fußwehren fehlen und sind umgehend zu ergänzen.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Gasflaschen sind ungesichert. Gegen Umfallen und fremde Inbetriebnahme schützen; zugelassene Lagerboxen verwenden oder von der Baustelle abtransportieren.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Kollektive Schutzmaßnahmen wurden entfernt. Sofort wiederherstellen; eine Demontage ist nur nach Abklärung mit dem Baukoordinator oder der Baufirma zulässig.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Das Gerüst-Abnahmeprotokoll fehlt. Es ist in wetterfester Hülle sichtbar bei jedem Aufstieg anzubringen; bis dahin Betreten nur nach Prüfung durch den Benützer.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Geländer bzw. Absturzsicherungen fehlen und sind wieder zu ergänzen.',
    freq: 2,
    related: ['lob']
  },
  {
    ...
    mangel: 'MANGEL: Das Baugelände ist nicht ausreichend gesichert. Der mindestens zwei Meter hohe Bauzaun ist zu vervollständigen (§ 4 Abs. 7 BauV).',
    freq: 2,
    related: []
  },
  {
    ...
    mangel: 'MANGEL: Dacharbeiten ohne kollektive Schutzmaßnahmen. Die Arbeiten sind einzustellen, bis die Schutzmaßnahmen errichtet sind.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Dämmstoffplatten sind direkt neben der Brüstung gelagert und umgehend zu entfernen; Schutzzonen zu brennbaren Materialien einhalten.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Ungeprüfte bzw. schadhafte Leiter im Einsatz. Die Leiter ist aus dem Verkehr zu ziehen und zu ersetzen.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Offene Bodenöffnungen. Sofort schließen oder tragfähig und unverschiebbar abdecken.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Der Drehbereich des Kranballastes ist nicht abgesichert und umgehend mit Wehren abzugrenzen.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Arbeiten mit KMF ohne Schutzmaske und Schutzkleidung. Fortsetzung nur mit PSA und gemäß KMF-Richtlinien.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Arbeitsplätze und Verkehrswege sind nicht von Eis und Schnee geräumt und umgehend trittsicher zu machen.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Waschplatz bzw. Aufenthaltsraum fehlen und sind auf Baudauer bereitzustellen (BauV §§ 33–37).',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Erste-Hilfe-Kasten bzw. Feuerlöscher fehlen und sind umgehend bereitzustellen.',
  ...
  },
  {
    ...
    mangel: 'MANGEL: Die Unterweisung der Mitarbeiter fehlt und ist nachweislich nachzuholen (ASchG § 14).',
