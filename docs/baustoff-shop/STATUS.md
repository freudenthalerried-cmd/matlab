...
>
> **Stand der Prüfmittel (01.09.):** 1059 Tests, `pruefe-tests` 1057/0, `pruefe-preise` 46/0, `pruefe-inhalte`
> 24/375/0, `pruefe-seiten` 81 von 81 gebauten Seiten, `pruefe-widerrufe` **319 Dateien/55
> Fundstellen**, `pruefe-preisalter` 46 Artikel (neu), **9 Prüfer** statt 8 (liest seit 31.08. auch Shoptexte, Werkzeuge und Rechenkern — vorher nur die Akte),
