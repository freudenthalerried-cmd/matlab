...
>
> **Stand der Prüfmittel (01.09.):** 1049 Tests, `pruefe-tests` 1047/0, `pruefe-preise` 46/0, `pruefe-inhalte`
> 24/375/0, `pruefe-seiten` 81 von 81 gebauten Seiten, `pruefe-widerrufe` **316 Dateien/55
> Fundstellen** (liest seit 31.08. auch Shoptexte, Werkzeuge und Rechenkern — vorher nur die Akte),
