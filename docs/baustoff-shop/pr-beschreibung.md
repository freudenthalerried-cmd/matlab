...
👉 **`docs/baustoff-shop/STATUS.md`** — Stand, offene Weisungen, Dokumentenverzeichnis und eine Tabelle aller Korrekturen, die im Verlauf nötig waren. Diese Datei zuerst lesen. Bei Gate-Fragen gilt **`gate-register.md`** (30 Gates, Stand 8. September).
...
- **6 Fragen an den Lieferanten**, alle freigabepflichtig, weil sie eine Anfrage an Dritte sind — sie stehen als fertiger Brief in `npm run pruefe-anfrage` und schließen zusammen alle zehn offenen Punkte dieser Gruppe: die **Lieferzeit in Werktagen**, sein **Liefergebiet** (aus fünfzehn Rechnungen nicht ableitbar, weil die Frachtpauschale nicht nach Entfernung staffelt), sein **Preisrhythmus** (er entscheidet, ob die 90-Tage-Grenze der Preisalterprüfung die richtige ist), die **Palettenzahl je Lieferung** (auf ihr ruht der Mindestbestellwert aus Gate 25 — und eine Stufe davor: welche Artikel überhaupt palettiert kommen, was wir heute aus der Warengruppe schätzen), die **Abholung durch unsere Kunden** an seinem Lager (seit Gate 28 vom 6. September: Der Shop hat kein eigenes Lager, sagte Abholung aber an fünf Stellen zu — belegt ist nur unsere eigene Abholung in Mauthausen) und eine **Artikelliste mit EAN-Spalte** aus dem Kundenkonto, die zugleich die GTIN-Frage und die Weisung löst, das Sortiment auf mindestens 100 Artikel zu erweitern.
