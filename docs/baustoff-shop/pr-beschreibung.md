...
👉 **`docs/baustoff-shop/STATUS.md`** — Stand, offene Weisungen, Dokumentenverzeichnis und eine Tabelle aller Korrekturen, die im Verlauf nötig waren. Diese Datei zuerst lesen. Bei Gate-Fragen gilt **`gate-register.md`** (32 Gates, Stand 9. September).
...
| Prüfwerkzeuge | **42 Prüfer** ohne Browser, 4 Browserproben zusätzlich |
