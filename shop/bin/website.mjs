...
.feldhinweis{font-size:.85rem;color:var(--gedaempft);margin:.15rem 0 .9rem;max-width:42rem}
  ...
  return {
    ...
    bestellung: {
      ...
      felder: WEG.aktiv ? BESTELLFELDER.map((f) => ({
        ...
        // **Der Satz für den Kunden — seit 15. September 2026.** Der `warum`
        // bleibt hier: Er nennt Gate-Nummern und ist an uns gerichtet.
