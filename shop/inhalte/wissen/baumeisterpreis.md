---
titel: Was „Baumeisterpreis" heißt — und was nicht
art: wissen
...
Ein Baustofflieferant räumt einem Verarbeiter andere Konditionen ein als einem
Endkunden. Das ist keine Besonderheit, sondern die übliche Struktur des
Baustoffhandels: Der Rabatt hängt an der Abnahmemenge, an der Regelmäßigkeit
und an der Warengruppe.
...
| Warengruppe | Lage |
|---|---|
| Kanal, Folien, Grundmauerschutz | der Vorteil ist am größten |
| Dämmplatten, WDVS, Kaminsystem | der Vorteil trägt deutlich |
| Mörtel und Putze | der Vorteil trägt, aber knapper |
| Kleinteile und Zubehör | **kein Preisvorteil** |

Die letzte Zeile ist der Grund für den Hinweis **„Beipack"** auf einigen
Artikeln. Diese Artikel sind bestellbar, weil sie zur Lieferung gehören —
Schaum, Klebeband, Schrauben. Sie sind aber kein Grund, hier zu bestellen.
...
- **Keine Fracht.** Sie wird getrennt ausgewiesen, weil sie je Lieferung
  anfällt und nicht je Artikel. Der Grund steht auf einer eigenen Seite:
  [Warum es keine Gratislieferung gibt](warum-keine-gratislieferung).
- **Keine Verarbeitung.** Wir liefern Material, keine Bauleistung.
- **Keine Umsatzsteuer.** Alle Preise sind Nettopreise für Unternehmer, die
  Umsatzsteuer wird getrennt ausgewiesen.

## Wie lange ein Preis gilt

Bis der Lieferant seine Liste ändert. Jeder Preis trägt deshalb einen
Preisstand. Verbindlich ist immer der Preis der Auftragsbestätigung, nicht
der der Website — das schützt beide Seiten vor einem Preisstand, den niemand
